...
var productcheckRouter = require("./routes/productcheck");
var customercheckRouter = require("./routes/customercheck");
var app = express();
...
app.use("/productcheck", productcheckRouter);
app.use("/customercheck", customercheckRouter);
